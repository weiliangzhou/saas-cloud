...
/**
 * <br> 微信获取用户信息 </br>
 * <br>微信url: https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN  </br>
 */
@Data
public class UserInfoVo extends WxErrorResultVo {
