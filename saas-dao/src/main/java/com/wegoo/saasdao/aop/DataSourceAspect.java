package com.wegoo.saasdao.aop;

import com.wegoo.saasdao.config.DatabaseContextHolder;
import com.wegoo.saasdao.config.DatabaseType;
import com.wegoo.saasdao.config.DynamicDataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("execution(* com.wegoo.saasdao.mapper.*.*(..))")//切点
    public void aspect() {
